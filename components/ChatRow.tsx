  ...
  return (
    <AppleStyleSwipeableRow>
      <Link href={`/(tabs)/chats/${id}`} asChild>
        <TouchableHighlight activeOpacity={0.8} underlayColor={Colors.light.lightGray}>
          <View
            style={{
              flexDirection: 'row',
              alignItems: 'center',
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 16, color: Colors.light.gray }}>
                {msg.length > 40 ? `${msg.substring(0, 40)}...` : msg}
              </Text>
            </View>
            <Text style={{ color: Colors.light.gray, paddingRight: 20, alignSelf: 'flex-start' }}>
